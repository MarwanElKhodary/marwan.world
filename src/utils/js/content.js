...
export const svgElements = {
    ...
    MOTHERBOARD_IN_CASE: `
        <svg class="z-30 dropzone text-rock dark:text-gasoline fill-none stroke-3 stroke-rock dark:stroke-gasoline size-7/12 md:scale-150" id="motherboard-in-case">
            <use href="/svg/motherboard-in-case.svg#motherboard-in-case"></use>
        </svg>`,
    GPU_IN_CASE: `
        <svg class="z-30 dropzone text-rock dark:text-gasoline fill-none stroke-3 stroke-rock dark:stroke-gasoline size-7/12 md:scale-150" id="gpu-in-case">
            <use href="/svg/gpu-in-case.svg#gpu-in-case"></use>
        </svg>`,
    HDD_IN_CASE: `
        <svg class="z-30 dropzone text-rock dark:text-gasoline fill-none stroke-3 stroke-rock dark:stroke-gasoline size-7/12 md:scale-150" id="hdd-in-case">
            <use href="/svg/hdd-in-case.svg#hdd-in-case"></use>
        </svg>`,
    PSU_IN_CASE: `
        <svg class="z-30 text-rock dark:text-gasoline fill-none stroke-3 stroke-rock dark:stroke-gasoline size-7/12 md:scale-150" id="psu-in-case">
